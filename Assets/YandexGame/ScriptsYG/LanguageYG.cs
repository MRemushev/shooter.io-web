...
namespace YG
{
  public class LanguageYG : MonoBehaviour
  {
    ...
    public TMP_Text textMeshProTextComponent;
    ...
    private void Awake()
    {
      ...
      //Serialize();
      //textMeshProTextComponent = GetComponent<TMP_Text>();
      //if (textMeshProTextComponent != null)
      //  textMeshProTextComponent.text = "Ararara";

      if (textUIComponent)
        baseFontSize = textUIComponent.fontSize;
      else if (textMeshComponent)
        baseFontSize = textMeshComponent.fontSize;
      else if (textMeshProTextComponent)
        baseFontSize = (int)textMeshProTextComponent.fontSize;
    }
    ...
    void AssignTranslate(string translation)
    {
      if (textUIComponent)
        ...
        textMeshProTextComponent.text = translation;
    }
    ...
    public void ChangeFont(Font[] fontArray)
    {
      ...
      if (font != null)
      {
        ...
        //else if (textMeshProTextComponent)
        //  textMeshProTextComponent.font = font;
      }
    }
    ...
    void FontSizeCorrect(int[] fontSizeArray)
    {
      if (textUIComponent)
        ...
        textMeshProTextComponent.fontSize = baseFontSize;
      ...
      if (fontSizeArray.Length != 0 && fontSizeArray.Length >= fontNumber - 1)
      {
        if (textUIComponent)
          ...
          textMeshProTextComponent.fontSize += fontSizeArray[fontNumber];
      }
    }
    ...
    string TranslateGoogle(string translationTo = "en")
    {
      ...
      if (!componentTextField)
        ...
        text = textMeshProTextComponent.text;
      else
      {
