  ...
  public class LanguageYGEditor : Editor
  {
    ...
    public override void OnInspectorGUI()
    {
      ...
      if (scr.textUIComponent == null && scr.textMeshComponent == null)
      {
        if (GUILayout.Button("Identify Text/TextMesh(Pro)"))
        {
          ...
          scr.textMeshProTextComponent = scr.GetComponent<TMP_Text>();
        }
        ...
        if (GUILayout.Button("Create TextMeshPro - Text компонент"))
          scr.textMeshProTextComponent = scr.gameObject.AddComponent<TMP_Text>();
      ...
      if (scr.infoYG)
      {
        if (scr.infoYG.translateMethod == InfoYG.TranslateMethod.CSVFile)
        {
          ...
          if (scr.componentTextField)
          {
            ...
            else if (scr.textMeshProTextComponent)
            {
              GUILayout.Label(scr.textMeshProTextComponent.text);

              if (scr.textMeshProTextComponent == null || scr.textMeshProTextComponent.text.Length == 0)
                availableStr = false;
            }
          }
          else
        ...
        else
        {
          ...
          if (scr.infoYG.translateMethod == InfoYG.TranslateMethod.AutoLocalization)
          {
            ...
            else
            {
              ...
              else if (scr.textMeshProTextComponent) GUILayout.Label(scr.textMeshProTextComponent.text);
            }
            ...
            if (scr.componentTextField)
            {
              ...
              {
                if (scr.textMeshProTextComponent.text.Length > 0)
                {
      ...
      if (scr.textUIComponent || scr.textMeshComponent || scr.textMeshProTextComponent)
      {
        GUILayout.Space(10);
        GUILayout.BeginVertical("box");
        ...
        if (GUILayout.Button("Replace the font with the standard one"))
        {
          if (scr.infoYG.fonts.defaultFont.Length >= scr.fontNumber + 1 && scr.infoYG.fonts.defaultFont[scr.fontNumber])
          {
            ...
            //else if (scr.textMeshProTextComponent)
            //  scr.textMeshProTextComponent.font = scr.infoYG.fonts.defaultFont[scr.fontNumber];
          }
          else
          {
    ...
    void TranslateButton()
    {
      ...
      if (!scr.componentTextField)
      {
        ...
        if (scr.textMeshProTextComponent)
          scr.textMeshProTextComponent.text = scr.text;
      }
    }
